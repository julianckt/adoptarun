...
5. **Strava Integration**: Ephemeral Strava OAuth + Client-side GPX file upload. Certificates generate unique persistent links (`/certificate/:cert_id`) stored in Cloudflare D1.
